...
for institute in CPC ;
	...
	for dataset in  ARC2;
		...
		for files in $path_observations_regridded_day/pr_*era5.nc ;
			...
			#cdo -L -O chname,longitude,lon -chname,latitude,lat $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_1.nc
			#$path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_2.nc
			...
			#ncpdq -O -a lat,lon,time $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_1.nc
#$path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_2.nc
			#mv $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_2.nc
#$path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_1.nc
		 	#ncks -O --fix_rec_dmn lat $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_1.nc
#$path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_2.nc
		 	#mv $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_2.nc
#$path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_1.nc
			#ncks -O --mk_rec_dmn time $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_1.nc
#$path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_2.nc
			#mv $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_2.nc
#$path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_1.nc
			rm $path_observations_regridded/spi/*.nc
			spi --periodicity monthly --scales 1 3 6 12 --calibration_start_year 1991 --calibration_end_year 2020 --netcdf_precip $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_1.nc --var_name_precip pr --output_file_base $path_observations_regridded/spi/${institute}_${dataset} --multiprocessing all
