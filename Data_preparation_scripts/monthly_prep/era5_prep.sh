...
domain=$( echo 'global' )
region=$( echo 'sadc')
for institute in ECMWF ; 
        do
        for dataset in  ERA5;
		do
		path_observations_regridded_day=$( echo /Volumes/tiro/atkins/activities/activity_2.1b/data/reanalysis/${domain}/gridded/${institute}/${dataset}/day/${region} )
		path_observations_regridded=$( echo /Volumes/tiro/atkins/activities/activity_2.1b/data/reanalysis/${domain}/gridded/${institute}/${dataset}/${period}/${region}/regridded )
