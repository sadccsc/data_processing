...
for institute in NOAA-CPC; 
	...
	for dataset in CMORPH-CDR;
		...
		for files in $path_observations_native/pr_day_NOAA-CPC_CMORPH-CDR_merged.nc ;
			do
		 	...
		 	#cdo remapbil,'era5_grid' $path_observations_native/`basename $files .nc`.nc $path_observations_regridded/`basename $files .nc`_lonlat_era5.nc
	 	done 
		...
		#cdo -L -O chname,precipitation,pr pr_day_${institute}_${dataset}_merged_lonlat_era5.nc pr_day_${institute}_${dataset}_merged_lonlat_era5_1.nc
		#mv pr_day_${institute}_${dataset}_merged_lonlat_era5_1.nc pr_day_${institute}_${dataset}_merged_lonlat_era5.nc
	 	
	 	## Compute Annual Climatology
	 	cdo -L -O -b F64 yearsum -setattribute,pr@units=mm/yr  pr_day_${institute}_${dataset}_merged_lonlat_era5.nc  pr_day_${institute}_${dataset}_merged_lonlat_era5_ann.nc
	 	cdo -L -O -b F64 timmean -selyear,2001/2020  pr_day_${institute}_${dataset}_merged_lonlat_era5_ann.nc pr_day_${institute}_${dataset}_merged_lonlat_era5_2001_2020_ann_clim.nc
	 	...
	 	cdo -L -O ydaypctl,99 -selyear,2001/2020  pr_day_${institute}_${dataset}_merged_lonlat_era5.nc -ydaymin  pr_day_${institute}_${dataset}_merged_lonlat_era5.nc -ydaymax pr_day_${institute}_${dataset}_merged_lonlat_era5.nc  indices/pr_day_${institute}_${dataset}_merged_lonlat_era5_2001_2020_99p.nc
	 	cdo -L -O ydaypctl,95 -selyear,2001/2020  pr_day_${institute}_${dataset}_merged_lonlat_era5.nc -ydaymin  pr_day_${institute}_${dataset}_merged_lonlat_era5.nc -ydaymax pr_day_${institute}_${dataset}_merged_lonlat_era5.nc  indices/pr_day_${institute}_${dataset}_merged_lonlat_era5_2001_2020_95p.nc
	 	...
	 	#	do
		 	...
		 	#	do
		 	#	cdo -L -O $index -selyear,$year pr_day_${institute}_${dataset}_merged_lonlat_era5.nc 
temp/${index}_${institute}_${dataset}_${year}_merged_lonlat_era5.nc
		 	...
		 	#cdo -L -O mergetime  temp/${index}_${institute}_${dataset}_*_merged_lonlat_era5_seas.nc 
indices/${index}_${institute}_${dataset}_all_merged_lonlat_era5_seas.nc
		...
		#	 		do
		#	 		cdo -L -O $index -selyear,$year  pr_day_${institute}_${dataset}_merged_lonlat_era5.nc  
indices/pr_day_${institute}_${dataset}_merged_lonlat_era5_2001_2020_${pctl}p.nc temp/${index}_${institute}_${dataset}_${year}_merged_lonlat_era5.nc
		#	 		
		#	 	done
		#	 	cdo -L -O mergetime  temp/${index}_${institute}_${dataset}_*_merged_lonlat_era5.nc indices/${index}_${institute}_${dataset}_all_merged_lonlat_era5.nc
		#	 	rm  temp/*
