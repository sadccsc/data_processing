...
for institute in GPCC; 
		...
		for files in $path_observations_regridded_day/pr_*era5.nc ;
			...
			ncatted -a bounds,time,d,, $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_1.nc
			#echo 'Change sequaence of dimensions'
			...
			#mv $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_2.nc $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_1.nc
		 	#echo 'Remove record dimension from lat'
			ncks -O --fix_rec_dmn lat $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_2.nc $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_3.nc
		 	#mv $paDth_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_2.nc$path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_1.nc
			#echo 'Set time as record dimension'
			ncks -O --mk_rec_dmn time $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_3.nc $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_4.nc
			#mv $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_2.nc 
			#$path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_1.nc
			
			rm $path_observations_regridded/spi/*.nc			
			spi --periodicity monthly --scales 1 3 6 --calibration_start_year 1991 --calibration_end_year 2020 --netcdf_precip $path_observations_regridded/pr_mon_${institute}_${dataset}_merged_lonlat_era5_4.nc --var_name_precip pr --output_file_base $path_observations_regridded/spi/${institute}_${dataset} --multiprocessing all
